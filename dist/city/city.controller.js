...
let CityController = class CityController {
    ...
    async getStatesByCountryId(stateId) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CityController.prototype, "getStatesByCountryId", null);
__decorate([
    (0, common_1.Get)('city/:name'),
    __param(0, (0, common_1.Param)('name')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CityController.prototype, "getstateByCity", null);
__decorate([
    (0, common_1.Get)(':id'),
